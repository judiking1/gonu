...
const Game = () => {
  ...
  if (!game) return <div>게임을 찾을 수 없습니다. <button onClick={() => navigate('/lobby')}>로비로</button></div>;
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 p-6 bg-gray-50 min-h-screen">
      <div className="flex-1 bg-white rounded-lg shadow-lg p-6">
        ...
        <GameBoard game={game} user={user} onNodeClick={handleNodeClick} selectedNode={selectedNode} />
        <GameActions
          game={game}
          isReady={isReady}
          onReady={handleReady}
